...
- **No prazo?** em acompanhamento — as tasks foram recebidas e ainda não executadas.

## Progresso da fase

- **Tasks:** 0/12 (0%)
- **Próxima task do champion:** T-F1-001 — disponibilizar o caminho principal de entrada, rascunho, retomada e payload de pedido.
...
|---|---|---|
| — | Nenhuma fase concluída; Fase 1 aberta | — |
